...
declare namespace MSImaging {
   ...
   */
   function MSI_ionStatPlot(mzpack:any, mz:any, met:any, sampleinfo:any, savePng:string, ionName:any, size:object, colorMap:any, MSI_colorset:string, ggStatPlot:any, padding_top:object, padding_right:object, padding_bottom:object, padding_left:object, interval:object, combine_layout:object, jitter_size:object, TrIQ:number, backcolor:string): object;
   /**
   */
